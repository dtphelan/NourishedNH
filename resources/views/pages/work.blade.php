        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We'll work together to fit your goals</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-6">
                    <span class="fa-stack fa-6x">
                        ...
                        <i class="fa fa-cutlery fa-stack-4x fa-inverse"></i>
                    </span>
                ...
                <div class="col-md-6">
                    <span class="fa-stack fa-6x">
                        <i class="fa fa-circle fa-stack-5x text-primary"></i>
                        <i class="fa fa-phone fa-stack-4x fa-inverse"></i>
                    </span>
